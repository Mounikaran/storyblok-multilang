    ...
    <header className="w-full bg-white">
      <nav className="" role="navigation">
        <div
          {...sbEditable(blok)}
          key={blok._uid}
          className="container mx-auto p-4 flex flex-wrap items-center justify-between md:flex-no-wrap"
        >
...
//             <ul className="flex justify-center flex-col mt-4 mx-4 pt-4 border-t md:flex-row lg:items-center md:mx-0 md:mt-0 md:pt-0 md:mr-4 md:ml-auto lg:mr-8 md:border-0">
//               <li>
